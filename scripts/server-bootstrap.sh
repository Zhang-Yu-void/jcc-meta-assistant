...
echo ""
echo "Cron: do NOT enable Aliyun crawl that overwrites Mac Playwright pushes."
echo "  Prefer: Mac ./scripts/crawl-and-push-aliyun.sh"
echo "  If needed: CRAWLER_SKIP=xhs ./scripts/crawl-and-publish.sh"
